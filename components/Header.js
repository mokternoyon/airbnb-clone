      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div className="flex items-center">
            <button
              onClick={resetInput}
              className="flex-grow text-gray-500 border-2 rounded-full py-2 mr-10 shadow-sm hover:shadow-md"
            >
              Cancel
            </button>
            <button
              onClick={search}
              className="flex-grow text-red-400 border-2 rounded-full py-2 ml-10 shadow-sm hover:shadow-md"
            >
              Search
            </button>
          </div>
